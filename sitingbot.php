...
bot('EditMessageText',[
'chat_id'=>$chat_id, 
'text'=>"اهلا بك عزيزي الادمن في قائمة التحكم الخاصة ببوت التمويل  
",
...
,
[['text'=>"تمويل قروب ",'callback_data'=>"tmoil_gr"],
['text'=>"تمويل بوت ",'callback_data'=>"tmoil_bo"],
['text'=>"تمويل قناة ",'callback_data'=>"tmoil_ch"]],
[['text'=>"➖ خصم نقاط ",'callback_data'=>"excoins"],
['text'=>"➕ اضافة نقاط",'callback_data'=>"addcoins"]]
,
[['text'=>"تحديد النقاط  ",'callback_data'=>"null"]]
,
[['text'=>"🎁 الهدية اليومية ",'callback_data'=>"نقاطهدية"],
['text'=>"♻ نقاط الاحالة ",'callback_data'=>"نقاطريفرل"]]
,
[['text'=>"↕ نقاط التحويل ",'callback_data'=>"نقاطتحويل"],
['text'=>"⬇ الحد الادنى  ",'callback_data'=>"الحدالادنى"]]
,
...
'message_id'=>$message_id,
"text"=>" مرحبا [$name](tg://user?id=$chat_id).
⏳ جاري ✂ خصم $co نقطة من جميع الاعضاء ..
",
'parse_mode'=>"MarkDown",
'disable_web_page_preview'=>true,
]);
